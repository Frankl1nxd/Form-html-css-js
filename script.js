/*ocument.getElementById("registroForm").addEventListener("submit", function(event) {  
...
document.getElementById("registroForm").addEventListener("submit", function(event) {
  ...
  // Si todo está bien, no se hace preventDefault y el formulario se enviará
  mensaje.textContent = `Gracias por registrarte, ${nombre}!`;
  mensaje.classList.add("exito");

  // No ponemos preventDefault aquí, así que se enviará a FormSubmit
});
